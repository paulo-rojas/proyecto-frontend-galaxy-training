...
import { EscuelaConductorResponseDto, PageInfo } from '../../models/gestion.models';
import { MatPaginatorIntl, MatPaginatorModule } from '@angular/material/paginator';
import { PaginatorCustomComponent } from '../../../../../shared/components/paginator.custom.component/paginator.custom.component';

export interface EscuelaAction {
  type: 'edit' | 'delete' | 'updateStatus';
  escuela: EscuelaConductorResponseDto;
}
...
export class EscuelaTablaComponent {
  // Inputs
  escuelas = input.required<EscuelaConductorResponseDto[]>();
